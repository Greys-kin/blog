    ...
    return (
      ...
      >
        <Spinner
          animation="border"
          role="status"
          style={{ fontSize: 100, color: "#0d6efd" }}
        >
    ...
    <section className={styles.ArticlePage}>
      <div className={styles["flex-container"]}>
        ...
        <div className={styles.profile}>
          ...
          {currentUser === user && (
            <div
              className={`${styles["flex-container"]} ${styles["flex-button"]}`}
            >
              <button
                type="button"
      ...
      {showNotification && (
        <AuthNotification onClose={handleNotificationClose} />
      )}
      <Modal show={showDeleteModal} onHide={() => setShowDeleteModal(false)}>
        <Modal.Body>
          <i
            className="bi bi-exclamation-circle-fill"
            style={{ fontSize: 20, color: "#ffa507", paddingRight: 8 }}
          ></i>
